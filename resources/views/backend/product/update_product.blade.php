                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <button type="button" class="btn btn-primary rounded-pill waves-effect waves-light"
                                    data-bs-toggle="modal" data-bs-target="#con-close-modal">< Back</button>
                            </div>
                            
                            <form method="POST" action="{{route('updating.product',$product->id)}}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input value="{{$product->product_name}}" name="product_name" type="text" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                ...
                                                <input  value="{{$product->product_code}}"  name="product_code" type="text" class="form-control"
                                        ...
                                        <div class="col-md-12">
                                            <div class="mt-3">
                                                <input value="{{ asset('upload/product/'.$product->product_image) }}"  name="product_image" type="file" data-plugins="dropify" />
